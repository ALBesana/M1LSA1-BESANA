class levelThree extends Phaser.Scene {
    ...
    create() {
        ...
        this.gameBackground = this.add.tileSprite(0, 0, this.scale.width, this.scale.height, 'levelThreeBG').setOrigin(0, 0);
        ...
        this.platforms.create(850, 200, 'ground');
        this.platforms.create(400, 310, 'ground').setScale(0.6).refreshBody();
        this.platforms.create(300, 440, 'ground');
        this.platforms.create(500, 440, 'ground');
        ...
        this.physics.add.overlap(this.player, this.bananaBundle, (player, prize) => {
            ...
            if (this.bananaCount >= 75 && !this.gameOver) {
                this.gameOver = true;
                this.physics.pause();
